...
1. Start by browsing [new issues](https://github.com/generativelabs/wasmd/issues).
   * Looking for a good place to start contributing? How about checking out some [good first issues](https://github.com/generativelabs/wasmd/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) or [bugs](https://github.com/generativelabs/wasmd/issues?q=is%3Aopen+is%3Aissue+label%3Abug)?
2. Determine whether a GitHub issue or discussion is more appropriate for your needs:
   1. If the issue you want addressed is a specific proposal or a bug, then open a [new issue](https://github.com/generativelabs/wasmd/issues/new).
   2. Review existing [issues](https://github.com/generativelabs/wasmd/issues) to find an issue you'd like to help with.
