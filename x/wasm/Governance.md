...
See [params.go](https://github.com/generativelabs/wasmd/blob/master/x/wasm/types/params.go)
...
### Update Params Via [MsgUpdateParams](https://github.com/generativelabs/wasmd/blob/v0.41.0/proto/cosmwasm/wasm/v1/tx.proto#L263)
...
### Tests
* [params validation unit tests](https://github.com/generativelabs/wasmd/blob/master/x/wasm/types/params_test.go)
* [genesis validation tests](https://github.com/generativelabs/wasmd/blob/master/x/wasm/types/genesis_test.go)
* [policy integration tests](https://github.com/generativelabs/wasmd/blob/master/x/wasm/keeper/keeper_test.go)
